                ...
                <form onSubmit={handleCreateDevice} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      pattern="^\+254[0-9]{9}$"
                    />
                    <p className="text-xs text-gray-500 mt-1">Format: +254XXXXXXXXX (Kenyan mobile number)</p>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="text-sm space-y-1">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-sm">{device.phone_number || "Not set"}</span>
                      </div>
                    </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="max-h-32 overflow-y-auto space-y-1">
                          {device.relay_channels.map((channel) => (
                            ...
                            >
                              <span className="text-gray-900 dark:text-gray-100">{channel.display_name}</span>
                              <Badge
                                variant="outline"
