  ...
  const handleCreateDevice = async (e) => {
    ...
    try {
      const deviceData = {
        ...
        price: Number(newDevice.price) || 0,
      };
      if (!newDevice.price) {
        toast({
          title: "Validation Error",
          description: "Please enter a price for the device.",
          variant: "destructive",
        });
        return;
      }
      ...
      if (newDevice.device_type === "vending_machine") {
        ...
        deviceData.max_capacity = Number(newDevice.max_capacity) || 5000;
        deviceData.current_level = 0;
        deviceData.total_amount = 0;
        deviceData.total_volume = 0;
        deviceData.stock = deviceData.max_capacity; // initialize with full tank
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                VendorFlow Admin Panel
              </h1>
              <p className="text-gray-600 dark:text-gray-400">
                Manage IoT devices and system settings
              </p>
            </div>
            <Dialog
                ...
                <form onSubmit={handleCreateDevice} className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="vending_machine">
                          Vending Machine
                        </SelectItem>
                        <SelectItem value="relay_device">
                          Relay Device
                        </SelectItem>
                    ...
                    <>
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setNewDevice({ ...newDevice, liquid_type: value })
                          }
                          required
                        >
                          <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewDevice({ ...newDevice, price: e.target.value })
                      }
            ...
            <Card className="text-center py-12">
              <CardContent>
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Create your first IoT device to get started
                </p>
